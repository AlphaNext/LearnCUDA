...
// using kernel type, but not support threadIdx.x XXXXX
// https://github.com/zchee/cuda-sample/blob/master/7_CUDALibraries/simpleDevLibCUBLAS/kernels.cu
//nvcc sgemm.cpp - lcublas
#include <stdio.h>
#include <stdlib.h>
...
int main(void){
    ...
    float al = 1.0f;       // alpha = 1
    float bet = 1.0f;      // beta = 1
